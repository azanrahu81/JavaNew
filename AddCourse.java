...
class  AddCourse extends JFrame implements MouseListener
{
	JFrame win;
	...
	public AddCourse()
	{
	   ...
	   //  sp.setBounds(255, 400, 505, 200);          
	     

       // // sp=new JScrollPane(jt);
       //  p3.add(sp);

        String [] columnsNames={"Course ID", "Course Name"};
		...
		b4.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(b4==ae.getSource())
				{
					...
					try
					{
						...
						Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/AddCourse","root","");
						Statement st=conn.createStatement();
						String query="INSERT into AddCourse1 (name) Values('"+t2.getText()+"')";
			...
			public void showdata()
			{
					try
					{
						...
						Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/AddCourse","root","");
						Statement st=conn.createStatement();
						ResultSet result=st.executeQuery("select * from AddCourse1");
