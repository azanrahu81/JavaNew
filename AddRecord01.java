...
class  AddRecord01  extends JFrame implements MouseListener
{
	JFrame win;
	JPanel p1, p2, p3, p4;
	...
	public AddRecord01()
	{
		...
		icon3=new ImageIcon("C:\\Users\\hp\\Desktop\\wallpapers\\update5.jpg");
		...
		scaledimage4= image4.getScaledInstance(120,120, Image.SCALE_SMOOTH);
		...
		win.setVisible(true);
			...
			// 		//new Login1();
				...
				// 	String g=cb2.getSelectedItem().toString();
					
				// 	String h=t9.getText();
				// 	String i=t10.getText();
				// 	String j=cb3.getSelectedItem().toString();
				// 	String k=cb4.getSelectedItem().toString();
				...
				// 		//String query="INSERT into submit1 ( Id, Payment, AccountName, Course, Total, Paid, Due, Submission, Month, Remarks) Values('"+a+"','"+aa+"', '"+b+"', '"+c+"','"+e+"','"+f+"', '"+g+"', '"+h+"','"+i+"','"+k+"')";
            ...
            public void actionPerformed(ActionEvent ae)
			{
				if(b2==ae.getSource())
				{
					...
					try
					{
					    ...
					    while(result.next())
						{
							if(t1.getText().equals(result.getString(1)))
							{


							cb.setSelectedItem(result.getString(2));
						     t3.setText(result.getString(3));
						     cb2.setSelectedItem(result.getString(4));
						     t5.setText(result.getString(5));
						     t6.setText(result.getString(6));
						     t7.setText(result.getString(7));
						    t8.setText(result.getString(8));
						     t9.setText(result.getString(9));
						     t10.setText(result.getString(10));
