...
class  ViewReport01 extends JFrame implements MouseListener
{
	JFrame win;
	...
	public ViewReport01()
	{
       ...
       // l4.setBorder(BorderFactory.createRaisedBevelBorder());
        ...
        scroll.setBounds(255, 400, 505, 225);
        ...
        b1.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				if(b1==ae.getSource())
				{
					String cb3=cb.getSelectedItem().toString();
					// view Report...................................................
					...
					try
					{
						...
						ResultSet result=st.executeQuery("select * from search1 where Submission between '"+ t1.getText()+"' and '"+t2.getText()+"' and Course ='"+cb3+"' ");
